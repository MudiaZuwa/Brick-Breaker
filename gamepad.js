...
//[3] right_y(xbox)
 ...
 if(isPressed) {
    switch(buttonIndex){
       case 2:
        if(this.game.gamestate!==0&&this.game.gamestate!==2&&this.game.gamestate!==3){
...
var RightStickY = this.applyDeadzone((this.myGamepad.axes[5]===undefined)?this.myGamepad.axes[3]:this.myGamepad.axes[5], 0.25);
